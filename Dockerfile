...
RUN cd /nova && git clone -b v7 --single-branch https://github.com/nova-t2k/DummyLLH.git

# Fetch Bifrost from git
RUN cd /nova && git clone -b v7 --single-branch https://github.com/nova-t2k/bifrost.git
